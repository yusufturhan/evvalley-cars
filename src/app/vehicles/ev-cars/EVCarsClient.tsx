...
export function EVCarsClient() {
  ...
  const listStructuredData = {
    ...
    "@type": "ItemList",
    "name": "Electric Cars for Sale",
    "description": "Browse the latest electric cars for sale on Evvalley",
            ...
            <main className="flex-1 vehicles-grid">
              ...
              <div className="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <div className="hidden md:flex items-center gap-2">
                  <label htmlFor="sort-select-ev" className="text-sm font-medium text-gray-700 whitespace-nowrap">
                    Sort by:
                  </label>
                  <select
                    id="sort-select-ev"
                  ...
                  <div className="relative">
                    <Link href={`/vehicles/${vehicle.id}`} className="block relative">
                      <div className="aspect-[4/3] bg-gray-200 flex items-center justify-center overflow-hidden">
                        {vehicle.video_url ? (
                          <video src={vehicle.video_url} playsInline controls className="w-full h-full object-contain bg-black transition-transform duration-200 ease-out md:group-hover:scale-105" />
      ...
      >
        <div className="space-y-4 px-4 py-4 pb-28">
          ...
          <div className="flex items-center gap-3 py-2">
            <input
              type="checkbox"
              id="mobile-showSoldVehicles-ev"
              checked={showSoldVehicles}
              onChange={(e) => setShowSoldVehicles(e.target.checked)}
              className="w-5 h-5 text-[#3AB0FF] bg-gray-100 border-gray-300 rounded focus:ring-[#3AB0FF] focus:ring-2"
            />
            <label htmlFor="mobile-showSoldVehicles-ev" className="text-sm font-medium text-gray-700">
              Show sold vehicles
            </label>
          </div>
        </div>
