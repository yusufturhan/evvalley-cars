        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90">
              Urban mobility redefined with electric power and style
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <Battery className="w-8 h-8 text-purple-600 mr-3" />
              <h2 className="text-3xl font-bold text-gray-900">Electric Scooters</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the freedom of electric mobility with our selection of high-performance 
              electric scooters. Perfect for urban commuting, these eco-friendly vehicles offer 
              convenience, style, and zero emissions.
            </p>
            <div className="mt-4 text-2xl font-bold text-green-600">
              {loading ? 'Loading...' : `${vehicles.length} Electric Scooters`} Currently Available
            </div>
          </div>
        </div>
      </section>
