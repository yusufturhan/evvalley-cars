...
export function EVScootersClient() {
  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        ...
        setError('Failed to load scooters. Please try again.');
      } finally {
        setLoading(false);
      }
    };
  ...
  const listStructuredData = {
    ...
    "description": "Browse the latest electric scooters for sale on Evvalley",
  ...
  return (
    <div className="min-h-screen bg-[#F5F9FF]">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Apollo" className="text-gray-900">Apollo</option>
                    <option value="Vsett" className="text-gray-900">Vsett</option>
                    <option value="Kaabo" className="text-gray-900">Kaabo</option>
                    <option value="Dualtron" className="text-gray-900">Dualtron</option>
                  ...
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                        ...
                        params.set('category', 'ev-scooter');
            ...
            <main className="flex-1 vehicles-grid">
              ...
              <div className="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <div className="hidden md:flex items-center gap-2">
                  <label htmlFor="sort-select-scooter" className="text-sm font-medium text-gray-700 whitespace-nowrap">
                    Sort by:
                  </label>
                  <select
                    id="sort-select-scooter"
                    value={sortBy}
              ...
              {vehicles.map((vehicle, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {/* CTA: Mobile & Desktop - Inline Message Composer */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Ultimate City Mobility</h3>
                <p className="text-gray-600 mb-4">
                  Electric scooters have revolutionized urban transportation, offering a compact, 
                  efficient, and fun way to navigate city streets. They're perfect for the "last mile" 
                  of your commute or as a primary mode of transport for short urban trips.
                </p>
                <p className="text-gray-600">
                  Modern EV scooters range from portable folding models for commuting to high-performance 
                  scooters with dual motors, advanced suspension systems, and impressive top speeds. 
                  Most models offer ranges between 15-50 miles on a single charge.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Selection & Technology</h3>
                <p className="text-gray-600 mb-4">
                  Evvalley features a wide variety of electric scooters from top brands like Segway, 
                  Xiaomi, Apollo, and Kaabo. Whether you need a lightweight scooter for the subway 
                  or a robust model for long-range cruising, you'll find it here.
                </p>
                <p className="text-gray-600">
                  When choosing a scooter, consider factors like motor power, battery capacity, weight, 
                  portability, and tire type. Many modern scooters also feature companion apps for 
                  tracking rides, locking the device, and customizing performance settings.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="space-y-4 px-4 py-4 pb-28">
          ...
          <div className="flex items-center gap-3 py-2">
            <input
              type="checkbox"
              id="mobile-showSoldVehicles-scooter"
              checked={showSoldVehicles}
              onChange={(e) => setShowSoldVehicles(e.target.checked)}
              className="w-5 h-5 text-[#3AB0FF] bg-gray-100 border-gray-300 rounded focus:ring-[#3AB0FF] focus:ring-2"
            />
            <label htmlFor="mobile-showSoldVehicles-scooter" className="text-sm font-medium text-gray-700">
              Show sold vehicles
            </label>
          </div>
        </div>
      ...
      {/* Structured Data */}
      <Script
        id="list-structured-data-scooter"
