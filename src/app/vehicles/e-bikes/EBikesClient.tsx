...
export function EBikesClient() {
  ...
  const listStructuredData = {
    ...
    "@type": "ItemList",
    "name": "Electric Bikes for Sale",
    "description": "Browse the latest electric bikes for sale on Evvalley",
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Rad Power" className="text-gray-900">Rad Power</option>
            ...
            <main className="flex-1 vehicles-grid">
              ...
              <div className="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <div className="hidden md:flex items-center gap-2">
                  <label htmlFor="sort-select-bike" className="text-sm font-medium text-gray-700 whitespace-nowrap">
                    Sort by:
                  </label>
                  <select
                    id="sort-select-bike"
      ...
      >
        <div className="space-y-4 px-4 py-4 pb-28">
          ...
          <div className="flex items-center gap-3 py-2">
            <input
              type="checkbox"
              id="mobile-showSoldVehicles-bike"
              checked={showSoldVehicles}
              onChange={(e) => setShowSoldVehicles(e.target.checked)}
              className="w-5 h-5 text-[#3AB0FF] bg-gray-100 border-gray-300 rounded focus:ring-[#3AB0FF] focus:ring-2"
            />
            <label htmlFor="mobile-showSoldVehicles-bike" className="text-sm font-medium text-gray-700">
              Show sold vehicles
            </label>
          </div>
        </div>
